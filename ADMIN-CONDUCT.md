# TriangleDesigners Code of Conduct - For Admins

This version is intended for internal use by the slack admins.

## Warnings

Any admin can issue a verbal warning to a participant if their behavior violates the group's anti-harassment policy. Warnings should be reported to the [internal admin channel][adminchan] as soon as practical. The report should include: 
...
[adminchan]: https://triangledevs.slack.com/messages/administrators/
